...
class EmployeesContractsByIntervalAndEntityType extends React.Component<Props, State> {
    ...
    render() {
        const limitedView = SearchFormLogic.makeLimitedViewFromSearchForm("/search/findByEntityTypeAndContractDate",
            [], this);
        return (<><h1>Договоры, выполняемые сотрудниками в диапазон дат</h1>
...
export default EmployeesContractsByIntervalAndEntityType;
